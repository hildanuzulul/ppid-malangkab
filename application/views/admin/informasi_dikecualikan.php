        ...
        <div class="main-content"  style="color:#545454;">
        	<div class="container-fluid py-4">
        		<h3 class="mb-4 fw-bolder">Informasi Dikecualikan</h3>
        		<div class="d-flex justify-content-end mb-3">
        			<a href="<?= base_url('admin_informasi_dikecualikan/tambah') ?>" class="btn btn-primary text-white">
        				<i class="fas fa-plus"></i> Tambah Informasi Dikecualikan
        			</a>
        		</div>
									...
									foreach ($informasi as $row): ?>
        								<tr>
											...
											<td style="white-space: nowrap; text-align: center;">
												<a href="<?= base_url('admin_informasi_dikecualikan/edit/' . $row->id) ?>" class="btn btn-warning btn-sm">
													<i class="fas fa-edit"></i>
												</a>
												<a href="<?= base_url('admin_informasi_dikecualikan/hapus/' . $row->id) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
