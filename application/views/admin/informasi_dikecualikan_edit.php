...
<div class="main-content" style="color:#545454;">
	<div class="container-fluid py-4 mx-3 pe-5">
		...
		<h3 class="mb-4 fw-bolder">Edit Informasi Dikecualikan</h3>

		<form action="<?= base_url('admin_informasi_dikecualikan/update/' . $informasi->id) ?>" method="post" enctype="multipart/form-data">
			<div class="row">
				<div class="col-6">
					...
					<div class="mb-3 text-start">
						...
						<input type="text" id="pejabat" name="pejabat" class="form-control" placeholder="Nama pejabat"
							value="<?= htmlspecialchars($informasi->pejabat) ?>">
					...
					<div class="mb-3 text-start">
						...
						<input type="text" id="penanggung_jawab" name="penanggung_jawab" class="form-control" placeholder="Nama penanggung jawab"
							value="<?= htmlspecialchars($informasi->penanggung_jawab) ?>">
				...
				<div class="col-6">
					<div class="mb-3 text-start">
						...
						<input type="text" id="jangka_waktu" name="jangka_waktu" class="form-control" placeholder="Contoh: 1 minggu, 1 bulan, Permanen"
							value="<?= htmlspecialchars($informasi->jangka_waktu) ?>">
			...
			<div class="d-flex justify-content-end">
				<a href="<?= base_url('admin_informasi_dikecualikan') ?>" class="btn btn-secondary me-2">Batal</a>
