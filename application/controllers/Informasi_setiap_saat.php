...
class Informasi_setiap_saat extends MY_Controller
{
	...
	public function index()
	{
		...
		// 2. Gunakan kategori “setiap_saat”
		...
		// 4. Setup pagination
		$config['base_url']            = base_url('informasi_setiap_saat/index');
		...
		$this->render('informasi_setiap_saat', $data);
	}
}
